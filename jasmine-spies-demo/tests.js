...
describe("A spy", function() {
  ...
  it("can provide the context and arguments to all calls", function() {
    ...
    expect(foo.setBar.calls.all()).toEqual([jasmine.objectContaining({object: foo, args: [123]})]);
  });
  ...
  it("has a shortcut to the most recent call", function() {
    ...
    expect(foo.setBar.calls.mostRecent()).toEqual(jasmine.objectContaining({object: foo, args: [456, "baz"]}));
  });
  ...
  it("has a shortcut to the first call", function() {
    ...
    expect(foo.setBar.calls.first()).toEqual(jasmine.objectContaining({object: foo, args: [123]}));
  });
...
describe("A spy, when created manually", function() {
  ...
  it("allows access to the most recent call", function() {
    whatAmI("I", "am", "also", "a", "spy");

    expect(whatAmI.calls.mostRecent().args).toEqual(["I", "am", "also", "a", "spy"]);
  });
});
